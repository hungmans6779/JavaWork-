...
<html>
 ...
 <body>
  ...
  <%
   ...
   //上一頁
   if(pageNo>1)
    out.print("<a href='http://hungmans6779.homeip.net/jsp/Ch11_5access.jsp?Sql="+sql+"&Page="+(pageNo-1)+"'>上一頁</a>");
   //下一頁
   if(pageNo<totalPages)
    out.print("<a href='http://hungmans6779.homeip.net/jsp/Ch11_5access.jsp?Sql="+sql+"&Page="+(pageNo+1)+"'>下一頁</a>");
