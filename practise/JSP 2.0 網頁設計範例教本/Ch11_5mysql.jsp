  ...
  <body>
   ...
   <%
	...
	if(totalRecorders>0)
	{
	 ...
	 out.print("</table>");
	 if(pageNo>1)
	  out.print("|<a href='http://hungmans6779.homeip.net/jsp/Ch11_5mysql.jsp?Sql="+sql+"&Page="+(pageNo-1)+"'>上一頁</a>|");
	 if(pageNo<totalPages)
	  out.print("|<a href='http://hungmans6779.homeip.net/jsp/Ch11_5mysql.jsp?Sql="+sql+"&Page="+(pageNo+1)+"'>下一頁</a>|");
