...
public class cSwingTest27
{
 ...
 public cSwingTest27()
 {
 	JFrame frame=new JFrame("cSwingTest27");
  ...
  */	                            
 	...
 	for(int i=0;i<7;i++)
 	{
 	 ...
 	 position.x+=20;
 	 position.y+=20;
 	 layeredPane.add(button[i],new Integer(100));
 	}	                             	                
 ...
 class MyEventHandler implements ActionListener
 {
 	public void actionPerformed(ActionEvent ae)
 	{
 	 ...
 	 //layeredPane.moveToBack(button);
 	 layeredPane.setPosition(button,layeredPane.getPosition(button)+1);
 	 System.out.println("變更後的position是："+layeredPane.getPosition(button));
 	 System.out.println("==========================================");
 	}	
 }	
