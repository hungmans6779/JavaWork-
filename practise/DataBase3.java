...
public class DataBase3 {
    ...
    //建構子
    public DataBase3(String driver_type,String dataBase,String table) {
        this.table=table;
                ...
                switch(item) {
                    ...
                    case 8: //查詢資料功能
                      ...
                      if(switchSearch%2==1)  //執行查詢的功能
                      {
                       ...
                       String sqlStr="select * from "+table+" where "+rsmd.getColumnName(2)+" like '%一%'";
                       //String sqlStr="select * from "+table+" where "+rsmd.getColumnName(2)+" like '%"+tf[2].getText()+"%'";
    ...
    public static void main(String argv[]) {
        new DataBase3("sun.jdbc.odbc.JdbcOdbcDriver","jdbc:odbc:Access_MyDB","student");
        new DataBase3("sun.jdbc.odbc.JdbcOdbcDriver","jdbc:odbc:Access_MyDB","score");
        new DataBase3("sun.jdbc.odbc.JdbcOdbcDriver","jdbc:odbc:SQL_MyDB","score");
        new DataBase3("sun.jdbc.odbc.JdbcOdbcDriver","jdbc:odbc:AllData_db","eatMenu");
        new DataBase3("sun.jdbc.odbc.JdbcOdbcDriver","jdbc:odbc:BigDatabase","飛狐工作室");
    }
