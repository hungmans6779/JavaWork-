...
public class Ex21 extends Canvas implements ItemListener,AdjustmentListener,MouseMotionListener,MouseListener,TextListener
{
 ...
 {
 	setSize(500,450);
 	f=new Frame("Ex21(畫圖形 vs. 加上文字輸入功能)  第二版本 --- 洪嘉宏於95年06月20日設計的程式");
