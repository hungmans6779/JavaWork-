...
public class Ex31 implements  ActionListener,TextListener
{
 static Frame f;
     ...
     try
     {
      ...
      for(int i=0;i<data.length;i++)
      {
       ...
       {	
        ...
        System.out.println("資料的索引為 : "+i);
        System.out.println("目前正在開啟的資料編號為 :"+data[i].serialNumber);
       }
      ...
      countIndex=maxCount-1;
      System.out.println("陣列索引 : "+countIndex);
      System.out.println("目前共有 : "+maxCount+"筆資料");
      objIn.close();
      fIn.close();
     }
   	...
   	{ 
   	 try
   	 {
   	  ...
   	  for(int i=0;i<=countIndex;i++)
   	  {
   	   ...
   	   System.out.println("已經確認存進了 "+data[i].serialNumber+"筆資料");
   	  } 
   	  objOut.close();
   	  fOut.close();
   	 }
 ...
 public void actionPerformed(ActionEvent e)
 {
 	...
 	switch(select)
 	{
 	 ...
 	 case 1: 
 	  ...
 	  count++;
 	  System.out.println("此筆 count : "+count);
 	  showData(count);
 ...
 { 
 	 //System.out.println("目前正在存資料的陣列索引 :"+countIndex);
  ...
  if(fileName!=null)
  {
 	 try
   {
    accessData(countIndex);
   	...
   	{
   	 objOut.writeObject(data[i]);
   	 System.out.println("陣列索引值為 : "+countIndex);
   	 System.out.println("目前所存的資料編號為 :"+data[i].serialNumber);
   	 System.out.println("已經確認存進了 "+data[i].serialNumber+"筆資料");
   	} 
   	 objOut.close();
 	   fOut.close();		
