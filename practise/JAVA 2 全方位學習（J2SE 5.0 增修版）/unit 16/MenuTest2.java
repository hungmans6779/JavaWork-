...
public class MenuTest2 extends MouseAdapter implements ActionListener,ItemListener
{
 Frame f;
 Label lb;
 PopupMenu pm;
 ...
 public MenuTest2()
 {
  ...
  MenuItem item3_2=new MenuItem("Item3_2",ms1);
 	...
 	MenuShortcut ms2=new MenuShortcut(KeyEvent.VK_C,false);
 	MenuItem item4=new MenuItem("Item4",ms2);
 	item4.addActionListener(this);
 	Menu menu2=new Menu("Menu2");
 	menu2.add(item4);
 	
 	MenuItem itemHelp=new MenuItem("itemHelp");
