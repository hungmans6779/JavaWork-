...
public class Index implements ItemListener,ActionListener,TextListener
{ 
 static int count=0,index=0;
 List ls,resultSelectLs;
 Button b1,b2,b3,bb,exitb;
 Button tfb1,tfb2;
 Label l2,talb;
 TextField tf;
 Checkbox cb1,cb2;
 ...
 public Index()
 {
  Frame f=new Frame("洪嘉宏的第一個AWT程式喔........");
  ...
  exitb=new Button("離開本程式");
  exitb.addActionListener(this);
  exitb.setActionCommand("7");
  p2.add(b1);
  p2.add(b2);
  p2.add(b3);
  p2.add(exitb);
