...
public class Index1 extends MouseAdapter implements ItemListener,AdjustmentListener,MouseMotionListener,TextListener
{
 Frame f;
 MyCanvasIndex1 myc;	
 ...
 public Index1()
 {
  f=new Frame("Index1(畫圖形 vs. 加上文字輸入功能) 第一版本 --- 洪嘉宏於95年06月20日設計的程式");
...
class MyCanvasIndex1 extends Canvas
{
